...
v37.8-fixbaseurl (2026-03-05)  ← 현재
  [Fix] KIS_BASE_URL 환경변수 우선 적용 (VTS 강제/덮어쓰기 제거)
  [Fix] 404 시 VTS 자동 스왑은 KIS_ALLOW_VTS_FALLBACK=1 일 때만 허용 (실전 기본 안정화)
  [Ops] 시작 로그에 KIS_BASE_URL 1회 출력 (환경 혼동 방지)
